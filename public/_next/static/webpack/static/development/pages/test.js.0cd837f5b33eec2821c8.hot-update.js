...
var ProductJson = function ProductJson(_ref2) {
  ...
  products.map(function (product) {
    return __jsx(react_bootstrap__WEBPACK_IMPORTED_MODULE_4__["Col"], {
      ...
      lg: 12,
      xl: 12,
      key: product.categories[0].id != 1 ? '' : product.id,
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 43,
      ...
      eventKey: product.categories[0].id != 1 ? '' : product.id,
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 46,
    ...
    }, product.categories[0].id != 1 ? '' : product.title), __jsx(react_bootstrap__WEBPACK_IMPORTED_MODULE_4__["Accordion"].Collapse, {
      eventKey: product.id,
      __self: _this,
      __source: {
        fileName: _jsxFileName,
    ...
    }), "Price:", (console.log(product.categories[0].name), !product.categories[0].id ? null : product.price), __jsx("br", {
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 54,
    ...
    }), "Category:", !product.categories[0].id ? null : product.categories[0].name, __jsx("br", {
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 57,
...
//# sourceMappingURL=test.js.0cd837f5b33eec2821c8.hot-update.js.map