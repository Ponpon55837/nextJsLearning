...
var ProductJson = function ProductJson(_ref2) {
  ...
  products.map(function (product) {
    ...
    }), "Price:", (console.log(product.categories[0].id), !product.categories[0].id == 2 ? '' : product.price), __jsx("br", {
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 55,
    ...
    }), "Category:", !product.categories[0].id == 2 ? '' : product.categories[0].name, __jsx("br", {
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 58,
...
//# sourceMappingURL=test.js.30ae144fdd5c8ef1cc85.hot-update.js.map