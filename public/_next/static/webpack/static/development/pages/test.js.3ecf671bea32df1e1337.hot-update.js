...
var ProductJson = function ProductJson(_ref2) {
  ...
  products.map(function (product) {
    ...
    }), "Price:", (console.log(product.categories[0].id), !product.categories[0].id == 1 ? '' : product.price), __jsx("br", {
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 55,
    ...
    }), "Category:", !product.categories[0].id == 1 ? '' : product.categories[0].name, __jsx("br", {
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 58,
...
//# sourceMappingURL=test.js.3ecf671bea32df1e1337.hot-update.js.map