...
var ProductJson = function ProductJson(_ref2) {
  ...
  products.map(function (product) {
    ...
    }), "Price:", (console.log(product.categories[0].id), !product.categories[0].id ? null : product.price), __jsx("br", {
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 54,
    ...
    }, "Quality:", product.quality), __jsx("br", {
      __self: _this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 58,
    ...
    }), "Create_at:", product.categories[0].id != 1 ? null : product.categories[0].created_at)))));
  })));
...
//# sourceMappingURL=test.js.b50b405d5d96c1d40770.hot-update.js.map